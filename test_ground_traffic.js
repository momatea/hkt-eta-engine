async function checkRawFeed() {
    try {
        ...
        // HKT bounds roughly:
        // North: 8.150, South: 8.080, West: 98.250, East: 98.350
        const bounds = "8.150,8.080,98.250,98.350";
        ...
        for (const [key, val] of Object.entries(data)) {
            ...
            console.log(`\nFound object ID: ${key}`);
            console.log(`  Callsign: ${val[16]} | Flight: ${val[13]}`);
        ...
        if (count === 0) {
            console.log("\nNo objects found in the HKT ground bounds right now.");
        }
